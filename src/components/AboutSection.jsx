        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Hello there! I'm a web and software developer with a passion for
              creating innovative solutions. I specialize in building
              responsive, user-friendly applications that solve real-world
              problems. My journey in tech has been fueled by curiosity and a
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Creating responsive websites and applications that provide
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Creating and managing databases to ensure data integrity and
                    accessibility.
                  </p>
                </div>
              </div>
